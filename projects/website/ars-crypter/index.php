<?php
    ...
    if (isset($post["encrypt-submit"])){
        if (!empty($post["input-crypt"])){
            $encrypted = encrypt($post["input-crypt"], (int)$post["sec-lvl"]);
        }
    } elseif (isset($post["decrypt-submit"])){
        if (!empty($post["input-decrypt"])){
            $decrypted = decrypt($post["input-decrypt"], (int)$post["sec-lvl"]);
        }
    }
?>
                ...
                <div id="navbar">
                    <span>
                        ...
                        <?php if (!SessionManager::is_registered($_SESSION)): ?>
                            <span class="pre"><a href="login.php"> Login </a></span>
                        <?php else: ?>
                            <span class="pre"><a href="logout.php"> Logout </a></span>
                        <?php endif; ?>
                        <br><br>
                    </span>
                </div>
